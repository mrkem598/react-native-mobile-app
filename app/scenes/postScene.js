...
export default class PostScene extends Component {
  ...
  //since we are going to want every post to have a picture
  //so we have to ask the user as soon as they come to this scene for one.
//I will use a life cycle hook called componentDidMount
  componentDidMount() {
